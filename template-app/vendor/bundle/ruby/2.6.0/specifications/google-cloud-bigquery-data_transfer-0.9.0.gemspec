# -*- encoding: utf-8 -*-
# stub: google-cloud-bigquery-data_transfer 0.9.0 ruby lib

Gem::Specification.new do |s|
  s.name = "google-cloud-bigquery-data_transfer".freeze
  s.version = "0.9.0"
  ...
  s.date = "2020-04-09"
  s.description = "google-cloud-bigquery-data_transfer is the official library for BigQuery Data Transfer API.".freeze
  s.email = "googleapis-packages@google.com".freeze
  s.homepage = "https://github.com/googleapis/google-cloud-ruby/tree/master/google-cloud-bigquery-data_transfer".freeze
  s.licenses = ["Apache-2.0".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.4".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "API Client library for BigQuery Data Transfer API".freeze
