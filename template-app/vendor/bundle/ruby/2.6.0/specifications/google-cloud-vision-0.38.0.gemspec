# -*- encoding: utf-8 -*-
# stub: google-cloud-vision 0.38.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2020-03-11"
  s.description = "google-cloud-vision is the official library for Cloud Vision API.".freeze
  s.email = "googleapis-packages@google.com".freeze
  s.homepage = "https://github.com/googleapis/google-cloud-ruby/tree/master/google-cloud-vision".freeze
  s.licenses = ["Apache-2.0".freeze]
  s.post_install_message = "The 0.32.0 release introduced breaking changes relative to the previous release, 0.31.0. For more details and instructions to migrate your code, please visit the migration guide: https://cloud.google.com/vision/docs/ruby-client-migration.".freeze
  s.required_ruby_version = Gem::Requirement.new(">= 2.4".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "API Client library for Cloud Vision API".freeze
