# -*- encoding: utf-8 -*-
# stub: google-cloud-resource_manager 0.36.2 ruby lib

Gem::Specification.new do |s|
  s.name = "google-cloud-resource_manager".freeze
  s.version = "0.36.2"
  ...
  s.date = "2021-07-08"
  s.description = "google-cloud-resource_manager is the official library for Google Cloud Resource Manager.".freeze
  s.email = ["mike@blowmage.com".freeze, "quartzmo@gmail.com".freeze]
  s.homepage = "https://github.com/googleapis/google-cloud-ruby/tree/master/google-cloud-resource_manager".freeze
  s.licenses = ["Apache-2.0".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.5".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "API Client library for Google Cloud Resource Manager".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<google-apis-cloudresourcemanager_v1>.freeze, ["~> 0.1"])
      ...
      s.add_dependency(%q<google-apis-cloudresourcemanager_v1>.freeze, ["~> 0.1"])
