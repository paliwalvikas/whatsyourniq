# -*- encoding: utf-8 -*-
# stub: google-cloud-dlp 0.15.0 ruby lib

Gem::Specification.new do |s|
  s.name = "google-cloud-dlp".freeze
  s.version = "0.15.0"
  ...
  s.date = "2020-03-18"
  s.description = "google-cloud-dlp is the official library for Cloud Data Loss Prevention (DLP) API.".freeze
  s.email = "googleapis-packages@google.com".freeze
  s.homepage = "https://github.com/googleapis/google-cloud-ruby/tree/master/google-cloud-dlp".freeze
  s.licenses = ["Apache-2.0".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.4".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "API Client library for Cloud Data Loss Prevention (DLP) API".freeze
