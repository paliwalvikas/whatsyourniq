# -*- encoding: utf-8 -*-
# stub: google-cloud-asset 0.8.1 ruby lib

Gem::Specification.new do |s|
  s.name = "google-cloud-asset".freeze
  s.version = "0.8.1"
  ...
  s.date = "2020-03-17"
  s.description = "google-cloud-asset is the official library for Cloud Asset API.".freeze
  s.email = "googleapis-packages@google.com".freeze
  s.homepage = "https://github.com/googleapis/google-cloud-ruby/tree/master/google-cloud-asset".freeze
  s.licenses = ["Apache-2.0".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.4".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "API Client library for Cloud Asset API".freeze
