# -*- encoding: utf-8 -*-
# stub: google-cloud-dialogflow 0.15.0 ruby lib

Gem::Specification.new do |s|
  s.name = "google-cloud-dialogflow".freeze
  s.version = "0.15.0"
  ...
  s.date = "2020-03-11"
  s.description = "google-cloud-dialogflow is the official library for Dialogflow API.".freeze
  s.email = "googleapis-packages@google.com".freeze
  s.homepage = "https://github.com/googleapis/google-cloud-ruby/tree/master/google-cloud-dialogflow".freeze
  s.licenses = ["Apache-2.0".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.4".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "API Client library for Dialogflow API".freeze
