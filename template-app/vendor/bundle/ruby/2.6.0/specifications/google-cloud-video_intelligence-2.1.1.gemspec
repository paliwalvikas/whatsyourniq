# -*- encoding: utf-8 -*-
# stub: google-cloud-video_intelligence 2.1.1 ruby lib

Gem::Specification.new do |s|
  s.name = "google-cloud-video_intelligence".freeze
  s.version = "2.1.1"
  ...
  s.date = "2020-04-01"
  s.description = "google-cloud-video_intelligence is the official library for Cloud Video Intelligence API.".freeze
  s.email = "googleapis-packages@google.com".freeze
  s.homepage = "https://github.com/googleapis/google-cloud-ruby/tree/master/google-cloud-video_intelligence".freeze
  s.licenses = ["Apache-2.0".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.4".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "API Client library for Cloud Video Intelligence API".freeze
