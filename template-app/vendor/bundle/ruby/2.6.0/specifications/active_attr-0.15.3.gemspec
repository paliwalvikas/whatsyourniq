# -*- encoding: utf-8 -*-
# stub: active_attr 0.15.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<actionpack>.freeze, [">= 3.0.2", "< 7.0"])
      s.add_runtime_dependency(%q<activemodel>.freeze, [">= 3.0.2", "< 7.0"])
      s.add_runtime_dependency(%q<activesupport>.freeze, [">= 3.0.2", "< 7.0"])
      ...
      s.add_dependency(%q<actionpack>.freeze, [">= 3.0.2", "< 7.0"])
      s.add_dependency(%q<activemodel>.freeze, [">= 3.0.2", "< 7.0"])
      s.add_dependency(%q<activesupport>.freeze, [">= 3.0.2", "< 7.0"])
