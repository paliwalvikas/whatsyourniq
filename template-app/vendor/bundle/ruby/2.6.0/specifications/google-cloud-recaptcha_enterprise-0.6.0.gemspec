# -*- encoding: utf-8 -*-
# stub: google-cloud-recaptcha_enterprise 0.6.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2020-04-08"
  s.description = "google-cloud-recaptcha_enterprise is the official library for reCAPTCHA Enterprise API.".freeze
  s.email = "googleapis-packages@google.com".freeze
  s.homepage = "https://github.com/googleapis/googleapis".freeze
  s.licenses = ["Apache-2.0".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.4".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "API Client library for reCAPTCHA Enterprise API".freeze
