# -*- encoding: utf-8 -*-
# stub: google-cloud-os_login 0.7.0 ruby lib

Gem::Specification.new do |s|
  s.name = "google-cloud-os_login".freeze
  s.version = "0.7.0"
  ...
  s.date = "2020-04-08"
  s.description = "google-cloud-os_login is the official library for Cloud OS Login API.".freeze
  s.email = "googleapis-packages@google.com".freeze
  s.homepage = "https://github.com/googleapis/google-cloud-ruby/tree/master/google-cloud-os_login".freeze
  s.licenses = ["Apache-2.0".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.4".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "API Client library for Cloud OS Login API".freeze
