# -*- encoding: utf-8 -*-
# stub: google-cloud-security_center 0.10.0 ruby lib

Gem::Specification.new do |s|
  s.name = "google-cloud-security_center".freeze
  s.version = "0.10.0"
  ...
  s.date = "2020-04-01"
  s.description = "google-cloud-security_center is the official library for Cloud Security Command Center API.".freeze
  s.email = "googleapis-packages@google.com".freeze
  s.homepage = "https://github.com/googleapis/googleapis".freeze
  s.licenses = ["Apache-2.0".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.4".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "API Client library for Cloud Security Command Center API".freeze
