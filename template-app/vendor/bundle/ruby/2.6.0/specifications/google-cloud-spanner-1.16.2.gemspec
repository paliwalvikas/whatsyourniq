# -*- encoding: utf-8 -*-
# stub: google-cloud-spanner 1.16.2 ruby lib

Gem::Specification.new do |s|
  s.name = "google-cloud-spanner".freeze
  s.version = "1.16.2"
  ...
  s.date = "2020-05-28"
  s.description = "google-cloud-spanner is the official library for Google Cloud Spanner API.".freeze
  s.email = ["mike@blowmage.com".freeze, "quartzmo@gmail.com".freeze]
  s.homepage = "https://github.com/googleapis/google-cloud-ruby/tree/master/google-cloud-spanner".freeze
  s.licenses = ["Apache-2.0".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.4".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "API Client library for Google Cloud Spanner API".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<grpc>.freeze, ["~> 1.26.0"])
      s.add_development_dependency(%q<grpc-tools>.freeze, ["~> 1.26.0"])
    else
      ...
      s.add_dependency(%q<grpc>.freeze, ["~> 1.26.0"])
      s.add_dependency(%q<grpc-tools>.freeze, ["~> 1.26.0"])
    end
  else
    s.add_dependency(%q<google-cloud-core>.freeze, ["~> 1.2"])
    s.add_dependency(%q<google-gax>.freeze, ["~> 1.8"])
