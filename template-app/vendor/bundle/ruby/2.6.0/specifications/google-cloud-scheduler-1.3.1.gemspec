# -*- encoding: utf-8 -*-
# stub: google-cloud-scheduler 1.3.1 ruby lib

Gem::Specification.new do |s|
  s.name = "google-cloud-scheduler".freeze
  s.version = "1.3.1"
  ...
  s.date = "2020-04-01"
  s.description = "google-cloud-scheduler is the official library for Cloud Scheduler API.".freeze
  s.email = "googleapis-packages@google.com".freeze
  s.homepage = "https://github.com/googleapis/googleapis".freeze
  s.licenses = ["Apache-2.0".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.4".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "API Client library for Cloud Scheduler API".freeze
