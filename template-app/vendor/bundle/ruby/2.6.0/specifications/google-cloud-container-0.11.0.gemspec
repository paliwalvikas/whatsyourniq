# -*- encoding: utf-8 -*-
# stub: google-cloud-container 0.11.0 ruby lib

Gem::Specification.new do |s|
  s.name = "google-cloud-container".freeze
  s.version = "0.11.0"
  ...
  s.date = "2020-04-10"
  s.description = "google-cloud-container is the official library for Kubernetes Engine API.".freeze
  s.email = "googleapis-packages@google.com".freeze
  s.homepage = "https://github.com/googleapis/google-cloud-ruby/tree/master/google-cloud-container".freeze
  s.licenses = ["Apache-2.0".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.4".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "API Client library for Kubernetes Engine API".freeze
