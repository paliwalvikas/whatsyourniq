# -*- encoding: utf-8 -*-
# stub: google-cloud-dataproc 0.10.0 ruby lib

Gem::Specification.new do |s|
  s.name = "google-cloud-dataproc".freeze
  s.version = "0.10.0"
  ...
  s.date = "2020-03-11"
  s.description = "google-cloud-dataproc is the official library for Google Cloud Dataproc API.".freeze
  s.email = "googleapis-packages@google.com".freeze
  s.homepage = "https://github.com/googleapis/google-cloud-ruby/tree/master/google-cloud-dataproc".freeze
  s.licenses = ["Apache-2.0".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.4".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "API Client library for Google Cloud Dataproc API".freeze
