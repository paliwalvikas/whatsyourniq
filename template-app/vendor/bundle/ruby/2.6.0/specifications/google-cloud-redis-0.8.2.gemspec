# -*- encoding: utf-8 -*-
# stub: google-cloud-redis 0.8.2 ruby lib

Gem::Specification.new do |s|
  s.name = "google-cloud-redis".freeze
  s.version = "0.8.2"
  ...
  s.date = "2020-04-02"
  s.description = "google-cloud-redis is the official library for Google Cloud Memorystore for Redis API.".freeze
  s.email = "googleapis-packages@google.com".freeze
  s.homepage = "https://github.com/googleapis/google-cloud-ruby/tree/master/google-cloud-redis".freeze
  s.licenses = ["Apache-2.0".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.4".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "API Client library for Google Cloud Memorystore for Redis API".freeze
