# -*- encoding: utf-8 -*-
# stub: google-cloud-phishing_protection-v1beta1 0.3.5 ruby lib

Gem::Specification.new do |s|
  s.name = "google-cloud-phishing_protection-v1beta1".freeze
  s.version = "0.3.5"
