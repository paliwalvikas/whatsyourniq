  ...
  class ProductWorker
    ...
    def product_data_import(file)
      ...
      csv.each.each do |product_data|
        ...
        filter_sub_category = BxBlockCategories::FilterSubCategory.find_or_create_by(
          name: product_params['category_type_filter'], filter_category_id: filter_category.id
        )
      ...
      BxBlockCatalogue::Product.import products
      BxBlockCatalogue::Ingredient.import ingredients
    end
  end
end
