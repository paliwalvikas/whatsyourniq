...
#     def initialize
#        append_url = "https://www.rozana.in"
#         @headers = {
...
#         @base_urls = (1..20).map{|a| "https://www.rozana.in/search?category=Beverages&page=#{a}" }
#     end

#       def scrap_data
#         file = "#{Rails.root}/public/rozana.csv"
#         csv_headers = ["Images"]
...
#               products = parsed_page.css('a.product-image')
#               products.each do |product|
#                 detail_url = product.attributes['href'].value rescue nil
#                 if detail_url
