module BxBlockCatalogue
  class Order < BxBlockCatalogue::ApplicationRecord
    ...
    def order_product_calculation
      ...
      return  { positive: {energy: energy_sum, vitamin: vitamins, minerals: minerals},negative: {fat: fat_sum, sugar: sugar_sum,},positive_points: positive_points,  negative_points: negative_points }
    end 
